        ...
        <div class="container">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-6">
                    ...
                    <span class="badge badge-info"> <a href=" {{route('voir_produit_par_tag' , ['id' => $tag->id])}} " style="color: #000 ;"> {{$tag->nom}} </a> </span>
                    @endforeach
                ...
                <div class="container">
                    ...
                    <div class="row">
                        @foreach ($produit->recommandations as $produit_recommande)
                            <div class="col-md-4">
                                <div class="card mb-4 box-shadow">
                                    <img src="{{asset('produits/' . $produit_recommande->photo_principale )}} " class="card-img-top img-fluid" alt="{{$produit_recommande->nom}} ">
